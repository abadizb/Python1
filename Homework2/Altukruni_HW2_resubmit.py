...
datalist=["And now here is my secret, a very simple secret: It is only with the heart that one can see rightly; what is essential is invisible to the eye.",
...
"If you tame me, it e to understand anything. They buy ready-made things in the shops. But since there are no shops where you can buy friends, men no longer have any friends.",
...
Dict = {}
for i, quote in enumerate(datalist):
    words = quote.split()
    for word in words:
